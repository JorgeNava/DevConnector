...
router.get('/', async (req, res) => {
    try {
        //Populate from collection user fields name and avatar
...
//@desc     Get profile of user by user_id
//@access   Public
...
//@desc     Get profile of user by user name
//@access   Public
...
//@desc     Get user github from github
//@access   Public
